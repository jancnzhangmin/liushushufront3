...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  ...
  <column name="iscollection" type="String" xid="xid14"></column></div>
  ...
  <column name="iscollection" type="String" xid="xid15"></column></div></div>  
  ...
  <span xid="span6" style="color:#C0C0C0;" bind-visible=' val("iscollection") == 1'><![CDATA[(已收藏)]]></span></div></div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row2">
   ...
   <div class="x-col text-right" xid="col6"><span xid="span3" bind-text="'￥' + val(&quot;price&quot;)" style="color:#ff651a;"></span></div></div>
