...
<div xmlns="http://www.w3.org/1999/xhtml" component="$UI/system/components/justep/window/window" design="device:m;" xid="window" class="window">  
  <div component="$UI/system/components/justep/model/model" xid="model" style="left:18px;top:83px;width:155px;height:auto;" onParamsReceive="modelParamsReceive"> 
  ...
  <column name="brand" type="String" xid="xid35"></column>
  <column name="projectdef" type="String" xid="xid36"></column></div>
  ...
  <column name="isselect" type="String" xid="xid25"></column></div>
  ...
  <column name="isselect" type="String" xid="xid26"></column></div>
  ...
  <div component="$UI/system/components/justep/data/data" autoLoad="true" xid="usercancelreasonData" idColumn="id"><column name="id" type="String" xid="xid33"></column>
  <column name="reason" type="String" xid="xid34"></column></div></div>  
  <div component="$UI/system/components/justep/panel/panel" 
   ...
   <span xid="span51"></span></a></div>
    ...
    <div class="x-panel-content x-cards" xid="content1"><div component="$UI/system/components/justep/smartContainer/smartContainer" class="x-smartcontainer" xid="smartContainer3" style="background-color:white;"><div component="$UI/system/components/justep/row/row" class="x-row" xid="row1" bind-click="row1Click">
   <div class="x-col" xid="col2"><span xid="span1" style="color:#2671b9;"><![CDATA[选择技工]]></span></div>
   <div class="x-col text-right" xid="col3"><span xid="span2" style="color:#2671b9;"><![CDATA[0]]></span>
  <i xid="i1" class="fa fa-chevron-right" style="width:20px;color:#2671b9;"></i></div></div></div><div component="$UI/system/components/justep/smartContainer/smartContainer" class="x-smartcontainer" xid="smartContainer1" style="background-color:white;margin-top:10px;">
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row15" bind-visible=" $model.transitData.count() &gt; 0">
   <div class="x-col text-center" xid="col42">
    <span xid="span23"><![CDATA[运输服务]]></span>
  </div> </div><div component="$UI/system/components/justep/list/list" class="x-list" xid="list2" data="transitData">
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row33">
   <div class="x-col" xid="col9">
    <span xid="span46"><![CDATA[项目]]></span></div> 
   <div class="x-col text-right" xid="col10">
    <span xid="span47" bind-text='val("projectdef")'></span></div> </div><div component="$UI/system/components/justep/row/row" class="x-row" xid="row22">
  ...
  <div component="$UI/system/components/justep/list/list" class="x-list" xid="list5" data="barbaseData" filter=' $row.val("isselect") == 1'>
  ...
  <div component="$UI/system/components/justep/list/list" class="x-list" xid="list6" data="barincrementData" filter=' $row.val("isselect")'>
...
<resource xid="resource2"><require xid="require1" url="css!$UI/liushushufront3/font-awesome-4.7.0/css/fa.icons"></require></resource>
  <div component="$UI/system/components/justep/popMenu/popMenu" class="x-popMenu" direction="right-bottom" xid="popMenu3" anchor="button5">
   ...
   <ul component="$UI/system/components/justep/menu/menu" class="x-menu dropdown-menu x-popMenu-content" xid="menu3">
    <li class="x-menu-item" xid="item3">
     <a component="$UI/system/components/justep/button/button" class="btn btn-link" label="　取消定单" xid="cannelBtn" icon="fa fa-remove" onClick="cannelBtnClick">
      <i xid="i7" class="fa fa-remove"></i>
      <span xid="span53">　取消定单</span></a> </li> 
    </ul> </div>
  <span component="$UI/system/components/justep/messageDialog/messageDialog" xid="messageDialog1" message="是否确认取消该定单？" type="YesNo" onYes="messageDialog1Yes"></span>
  <div component="$UI/system/components/justep/popOver/popOver" class="x-popOver" direction="auto" xid="usercancelreasonPop">
   ...
   <div class="x-popOver-content" xid="div4" style="width:70%"><div component="$UI/system/components/justep/smartContainer/smartContainer" class="x-smartcontainer" xid="smartContainer2" style="background-color:white;">
  <div component="$UI/system/components/justep/row/row" class="x-row tb-box" xid="row31">
   <div class="x-col" xid="col13"><a component="$UI/system/components/justep/button/button" class="btn btn-sm btn-only-icon tb-backBtn" label="button" xid="button3" icon="fa fa-times" onClick="button3Click">
   <i xid="i4" class="fa fa-times"></i>
   <span xid="span44"></span></a></div></div><div component="$UI/system/components/justep/list/list" class="x-list" xid="list9" data="usercancelreasonData">
   <ul class="x-list-template" xid="listTemplateUl9" style="margin-bottom:-1px;">
    <li xid="li7" class="list-group-item"><span component="$UI/system/components/justep/button/radio" class="x-radio" xid="radio1" name="usercancelreason" onChange="radio1Change"></span>
  <span xid="span43" bind-text='val("reason")'></span></li></ul> </div>
  <ul xid="ul1"><li xid="li8" class="list-group-item"><span component="$UI/system/components/justep/button/radio" class="x-radio" xid="otherreasonradio" name="usercancelreason" label="其它"></span>
  ...
  <div component="$UI/system/components/justep/row/row" class="x-row" xid="row32">
   <div class="x-col" xid="col22"><a component="$UI/system/components/justep/button/button" class="btn btn-default btn-block" label="提交" xid="seasonsubmitBtn" onClick="seasonsubmitBtnClick">
   <i xid="i10"></i>
   <span xid="span45">提交</span></a></div></div></div></div></div></div>